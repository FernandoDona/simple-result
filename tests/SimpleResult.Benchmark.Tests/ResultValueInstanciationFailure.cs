...
public class ResultValueInstanciationFailure
{
    ...
    [Benchmark]
    public FluentResults.Result<int> Instantiate_FluentResultGeneric_WithErrors()
    {
    ...
    [Benchmark]
    public Ardalis.Result.Result<int> Instantiate_ArdalisResultGeneric_WithErrors()
    {
